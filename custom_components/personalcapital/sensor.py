...
class PersonalCapitalBudgetCategorySensor(Entity):
    """Represents a monthly budget category from personalcapital.com sensor"""

    def __init__(self, rest, hass, unit_of_measurement, name, amount):
        self.hass = hass
        self._rest = rest
        self._unit_of_measurement = unit_of_measurement
